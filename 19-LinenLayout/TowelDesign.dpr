program TowelDesign;
(* as: TowelDesign.exe, a Windows console app
 * in: Delphi 12.2
 * on: December, 2024
 * by: David Cornelius
 * to: Solve Day 19a of Advent of Code, 2024 (https://adventofcode.com/2024/day/19)
 *)
...
begin
  Writeln('Day 19a of Advent of Code, 2024 (https://adventofcode.com/2024/day/19)');
